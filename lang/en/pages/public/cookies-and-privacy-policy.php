...
return [
	...
	'cookies' => [
		'title' => 'Cookies',
		'description' => 'We use cookies and similar technologies to provide and improve our service. All cookies we use are essential for the proper functioning of the website.',
		'essential' => [
			'title' => 'Essential Cookies',
			'description' => 'These cookies are necessary for the website to function and cannot be switched off:',
			'session' => [
				'name' => 'Session Cookie',
				'purpose' => 'Maintains your login session and preserves your data while browsing',
			],
			'csrf' => [
				'name' => 'CSRF Token',
				'purpose' => 'Protects against cross-site request forgery attacks for your security',
			],
			'auth' => [
				'name' => 'Authentication Token',
				'purpose' => 'Remembers your login status and user preferences',
			],
		],
	],
	...
	'dataUsage' => [
		...
		'purposes' => [
			...
			'communication' => 'To send important messages about your account or our service (if for example you reset your password or if we update our Terms of Use etc.)',
	...
	'dataSharing' => [
		...
		'noSharing' => 'We do not sell, trade, or otherwise transfer your personal information to third parties. Your prompts and personal data remain private and are never shared with external parties.',
